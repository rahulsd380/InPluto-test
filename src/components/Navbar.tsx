...
const Navbar = () => {
    ...
    return (
        <div
            className="bg-[#06050B] bg-cover bg-center bg-no-repeat min-h-screen relative"
            style={{ backgroundImage: `url(${IMAGES.gradientBg})` }}
        >
            <img src={IMAGES.gradientBg} alt="" className="absolute w-full" />
            {/* Overlay for better readability */}
            {/* <div className="absolute inset-0 bg-[#06050B] opacity-60"></div> */}
